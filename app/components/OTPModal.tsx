	...
	return (
		<AlertDialog open={isOpen} onOpenChange={setIsOpen}>
          ...
          <div className='flex w-full flex-col gap-4'>
					<AlertDialogAction onClick={handleSubmit} className='shad-submit-btn h-12 bg-brand' type='button'>Submit
            {isLoading && 
            <Image src={'assets/icons/loader.svg'} alt='loader logo' width={20} height={20} className='animate-spin'/>
            } 
          </AlertDialogAction>
